...
export const profile = {
  ...
  funFacts: [
    ...
    "Always experimenting with a new microcontroller or AI model",
    "Believe the best products live where software meets the physical world"
  ],
  stats: [
